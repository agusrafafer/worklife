...
var openFB = (function () {
    ...
    function login(callback, options) {
        ...
        loginWindow = window.open(loginURL + '?client_id=' + fbAppId + '&redirect_uri=' + redirectURL +
            '&response_type=token&scope=' + scope + '&display=touch', '_blank', 'location=yes,clearcache=yes');
    ...
    function api(obj) {
        ...
        url = 'https://graph.facebook.com' + obj.path + '?' + toQueryString(params) + '&display=touch&fields=id,first_name,last_name,email';
